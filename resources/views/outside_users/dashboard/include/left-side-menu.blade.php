<div class="sticky">
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('outsider.user.dashboard', ['id' => $outside_user->id]) }}">
                <img src="{{asset('/')}}admin/images/brand/webns_logo.png" class="header-brand-img desktop-logo w-100" alt="logo" style="height: 50px;">
                <img src="{{asset('/')}}admin/images/brand/webns_logo.png" class="header-brand-img toggle-logo w-100" alt="logo" style="height: 50px;">
                <img src="{{asset('/')}}admin/images/brand/webns_logo.png" class="header-brand-img light-logo w-100" alt="logo" style="height: 50px;">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('outsider.user.dashboard', ['id' => $outside_user->id]) }}">
...
{{--                @endphp--}}
{{--                @if($permissionData && isset($permissionData['users_all']) && $permissionData['users_all'] == 'department_manage')--}}
                    <li class="slide">
...
{{--                            @if($permissionData && isset($permissionData['users_all']['employ_all']['employ_manage']) && $permissionData['users_all']['employ_all']['employ_manage'] == 'employ_manage')--}}
                                <li>
                                    <a href="{{ route('outsider.user.player.create') }}" class="slide-item">Manage Players</a>
                                </li>
{{--                            @endif--}}
{{--                            @if($permissionData && isset($permissionData['users_all']['user_department']['department_manage']) && $permissionData['users_all']['user_department']['department_manage'] == 'department_manage')--}}
                                <li>
                                    <a href="{{ route('outsider.user.coach.create') }}" class="slide-item">Manage Coach</a>
                                </li>
                                {{--                            @endif--}}
                        </ul>
                    </li>

...
{{--<script src="{{asset('/')}}outside_user/boostrap_5.3/dist/js/bootstrap.bundle.min.js"></script>--}}
{{--<script src="{{asset('/')}}outside_user/boostrap_5.3/dist/js/owl.carousel.min.js"></script>--}}
...
{{--carousel slider for match detail--}}
<script src="{{ asset('/') }}admin/customize/product-carousel/lib/owlcarousel/owl.carousel.min.js"></script>
<script src="{{ asset('/') }}admin/customize/product-carousel/lib/counterup/counterup.min.js"></script>
<script src="{{ asset('/') }}admin/customize/product-carousel/js/main.js"></script>

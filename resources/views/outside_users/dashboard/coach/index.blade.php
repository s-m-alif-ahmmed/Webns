...
@section('content')
    ...
    <section class="py-5">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Coach</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        @php
            $outside_user_id = \Illuminate\Support\Facades\Session::get('outside_user_id');
            $playerCount = \App\Models\OutsideUsers\OutsideUserPlayer::where('outside_user_id', $outside_user_id)->count();
        @endphp
        @if ($playerCount < 1)

        <!-- Create Blog Form-->
        <p class="mb-0 py-2 text-center fw-bold" style="color: #F8C243; font-size: 24px;">Add New Coach </p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row" method="post" action="{{route('outsider.user.coach.store', $outside_user->id)}}" enctype="multipart/form-data">
                                @csrf
        ...
        <p class="mb-0 py-2 text-center fw-bold" style="color: #F8C243; font-size: 24px;">Manage Coach </p>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap border-bottom w-100" id="responsive-datatable" style="width:100%">
                        ...
                        <tbody>
                        @foreach($outside_user_coaches->where('outside_user_id', session('outside_user_id')) as $coach)
                            <tr>
                                <td>
                                    {{$loop->iteration}}
                                </td>
                                ...
                                <td>
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="Edit">
                                        <a href="{{route('outsider.user.coach.edit', Crypt::encryptString($coach->id))}}" class="text-warning mx-1"><i class="fa fa-edit"></i></a>
                                    </span>
                                </td>

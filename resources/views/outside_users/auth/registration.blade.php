            ...
            <div class="row">
                <div class="col-md-12 p-0 text-center">
                    <div class="top-text" style="height: 100px; position: relative; overflow: hidden;">
                        <h2 class="fw-900 text-uppercase" style="font-size: 60px; letter-spacing: -2px; color: var(--text-light-ash); margin: 0; position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 2;">StepsERP Pharma Cup 2024</h2>
                        <h4 class="fw-900 top-contact text-capitalize" style="color: var(--yellow)!important; font-size: 30px; margin-top: 18px; margin-bottom: -1px; position: relative; z-index: 3; ">Registration Rules & Form</h4>
                    </div>
                </div>
            </div>
        </div>

                    ...
                    <div class="top-text" style="height: 100px; position: relative; overflow: hidden;">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('tools-and-platform') }}" style="color: var(--ash)!important; font-size: 14px; position: relative; z-index: 3;">Tools & Platform</a></li>
...
{{--                    <p class="test-gradient fw-900">Human Resources Management System (HRMS)</p>--}}
            ...
            <div class="row py-5">
                <div class="col-md-12">
                    <h1 class="fw-900 text-center" style="font-size: 36px;">Tools & Platform Name</h1>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <p class="text-center fw-700" style="font-size: 36px;">
                        Why we Choose this Tools & Platform?
                    </p>
                    <div class="row">
            ...
            <div class="row py-5 my-3">
                <div class="col-md-6 p-5">
                    <p class="text-center fw-700" style="font-size: 36px;">
                        What we have in our tools & platform?
                    </p>
                    <p class="text-center">
            ...
            <div class="row py-5 my-3">
                ...
                <div class="col-md-6 p-5">
                    <p class="text-center fw-700" style="font-size: 36px;">
                        How easy to use our tools & platform?
                    </p>
                    <p class="text-center">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur atque consequuntur ducimus, est et quis sequi soluta totam unde vero? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad assumenda culpa cupiditate distinctio eveniet exercitationem ipsum iure molestiae perferendis perspiciatis!
                    </p>

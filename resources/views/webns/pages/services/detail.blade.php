            ...
            <div class="row">
                <div class="col-md-12 p-0 text-center">
                    <div class="top-text" style="height: 100px; position: relative; overflow: hidden;">
                        <p class="fw-900 text-uppercase heading-down-style">Service</p>
...
{{--                    <p class="test-gradient fw-900">Human Resources Management System (HRMS)</p>--}}
            ...
            <div class="row py-5">
                <div class="col-md-12">
                    <h1 class="fw-900 text-center" style="font-size: 36px;">Service Name</h1>
                </div>

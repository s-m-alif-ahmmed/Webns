            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0 text-center">Add New Blog </h5>
                    </div>
                    <div class="card-body">
                        <!-- ROW-1 OPEN -->
                                                    ...
                                                    <form action="{{ route('admin-blog.store') }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div id="form-one">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input class="form-control" maxlength="100" type="text" name="title" id="title" placeholder="Enter title" required />
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea class="form-control" maxlength="150" name="short_description" id="short_description" placeholder="Enter short description" required ></textarea>
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">
...
{{--                                                                <textarea class="form-control" name="description" id="note1" placeholder="Enter description" ></textarea>--}}
                                                                <textarea class="form-control" name="description" id="editor1" style="min-height: 200px;" placeholder="Enter description" ></textarea>
                                                            </div>

                                                            <div class="col-12">
                                                                <label for="image" class="form-label"> Featured Image </label>
                                                                <input class="form-control" type="file" name="image" id="image" placeholder="Enter featured image" oninput="validateImageSize()" required />
                                                                <small id="imageSizeError" style="color: red;"></small>
                                                            </div>

                                                            <div class="col-12">
                                                                <label for="alt" class="form-label"> Featured Image Alt Text </label>
                                                                <input class="form-control" type="text" name="alt" id="alt" placeholder="Enter featured image alt text " required />
                                                            </div>
                                                        ...
                                                        <div id="form-two" >
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input class="form-control" maxlength="100" type="text" name="meta_title" id="meta_title" placeholder="Enter meta title" required />
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea class="form-control" maxlength="200" name="meta_description" id="meta_description" placeholder="Enter meta description" required ></textarea>
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">
                                                    ...
                                                    <form action="{{ route('admin-blog.store') }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div id="form-three">
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <div class="text-right">
                                                                    <select class="form-select form-select px-3" name="language" style="width: 100px;">
                                                                        <option value="বাংলা" selected>বাংলা</option>
                                                                        <option value="Both" >Both</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input class="form-control" maxlength="100" type="text" name="title" id="bangla-title" placeholder="ব্লগ শিরোনাম লিখুন" required />
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea class="form-control" maxlength="150" name="short_description" id="bangla_short_description" placeholder="ব্লগ সংক্ষিপ্ত বিবরণ লিখুন" required ></textarea>
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">
                                                            ...
                                                            <div class="col-12">
                                                                <label for="summernote" class="form-label"> ব্লগ বিবরণ </label>
{{--                                                                <textarea class="form-control" name="description" id="note2" placeholder="ব্লগ বিবরণ লিখুন" ></textarea>--}}
                                                                <textarea class="form-control" name="description" id="editor" placeholder="ব্লগ বিবরণ লিখুন" ></textarea>
                                                            </div>

                                                            <div class="col-12">
                                                                <label for="image" class="form-label"> ফিচার্ড ছবি </label>
                                                                <input class="form-control" type="file" name="image" id="image-bangla" placeholder="ফিচার্ড ছবি লিখুন" oninput="validateImageSizeBangla()" required />
                                                                <small id="imageSizeErrorBangla" style="color: red;"></small>
                                                            </div>

                                                            <div class="col-12">
                                                                <label for="alt" class="form-label"> ফিচার্ড ছবি অল্ট টেক্সট </label>
                                                                <input class="form-control" type="text" name="alt" id="alt" placeholder="ফিচার্ড ছবি অল্ট টেক্সট লিখুন" required />
                                                            </div>
                                                        ...
                                                        <div id="form-four" >
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input class="form-control" maxlength="100" type="text" name="meta_title" id="bangla-meta-title" placeholder="মেটা শিরোনাম লিখুন" required />
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea class="form-control" maxlength="200" name="meta_description" id="bangla_meta_description" placeholder="মেটা বিবরণ লিখুন" required ></textarea>
                                                                <div class="justify-content-between d-flex my-1">
                                                                    <div class="">

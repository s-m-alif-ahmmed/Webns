                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($permissionData && isset($permissionData['users_all']['employ_all']['employ_restriction']) && $permissionData['users_all']['employ_all']['employ_restriction'] == 'employ_restriction')
                                            @if($user->ban_status == 1)
                                                <a href="{{ route('change.ban.status', $user->id) }}" onclick="return BanAction(event, 'Are you sure to unrestricted this user?', 'btn-success')" class="btn btn-danger btn-sm">Restricted</a>
                                            @elseif($user->ban_status == 0)
                                                <a href="{{ route('change.ban.status', $user->id) }}" onclick="return BanAction(event, 'Are you sure to restricted this user?', 'btn-danger')" class="btn btn-success btn-sm">Unrestricted</a>
                                            @endif
                                        @endif
                                    </td>
                                    <td>

                            ...
                            <div class="row">
                                ...
                                <div class="d-flex">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" style="margin-top: 50px; height: 500px!important; width: 500px!important;">
                                                <div class="modal-content" >
                                                    ...
                                                    <form action="{{ route('photo.update', $user->id) }}" id="imageForm" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <input type="hidden" name="officer_id" value="{{ $user->officer_id ?? '' }}">
                                    ...
                                    <div class="col-md-10 pt-2">
                                        ...
                                        <h6 class="ps-1">{{ $user->designation->name }}</h6>
                                        </span>
                                        @endif
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                @if ($user->officer_id)
                                                    <input class="bg-white" value="{{$user->officer_id}}" disabled readonly />
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                @if($user->role == 'super_admin')
                                                    <input class="bg-white" value="Super Admin" disabled readonly />
                                                @elseif($user->role == 'admin')
                                                    <input class="bg-white" value="Admin" disabled readonly />
                                                @elseif($user->role == 'hr')
                                                    <input class="bg-white" value="HR" disabled readonly />
                                                @elseif($user->role == 'content_manager')
                                                    <input class="bg-white" value="Content Manager" disabled readonly />
                                                @elseif($user->role == 'viewer')
                                                    <input class="bg-white" value="Viewer" disabled readonly />
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                @if ($user->department)
                                                    <input class="bg-white" value="{{$user->department->name}}" disabled readonly />
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                @if ($user->designation)
                                                    <input class="bg-white" value="{{$user->designation->name}}" disabled readonly />
                                                @endif
                                            </div>
                                        </div>
                                    </div>

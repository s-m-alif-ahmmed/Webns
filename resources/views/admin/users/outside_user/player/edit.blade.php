                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row" method="post" action="{{route('admin.outsider.user.player.update', $outside_user_player->id)}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="designation" id="designation" value="{{ $outside_user_player->designation }}" required />
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="employ_id" id="employ_id" value="{{ $outside_user_player->employ_id }}" required />
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" name="employ_id_image" id="employ_id_image" value="{{ $outside_user_player->employ_id_image }}"  />
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" name="image" id="image" value="{{ $outside_user_player->image }}"  />

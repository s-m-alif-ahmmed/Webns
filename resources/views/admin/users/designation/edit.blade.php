                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row" method="POST" action="{{route('designation.update', Crypt::encryptString($designation->id))}}">
                                @csrf
                                @method('patch')

                                <div class="col-12 form-group">
                                    <label class="form-label"> Department Name </label>
                                    <select class="form-control select2 form-select" name="department_id" data-placeholder="Choose one department" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Enter designation name" value="{{ $designation->name }}" required />

                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        @if(Auth::user()->officer_id)
                                                            <p class="form-control" >{{Auth::user()->officer_id}}</p>
                                                        @else
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        @if(Auth::user()->role == 'super_admin')
                                                            <p class="form-control" >Super Admin</p>
                                                        @elseif(Auth::user()->role == 'admin')
                                                            <p class="form-control" >Admin</p>
                                                        @elseif(Auth::user()->role == 'hr')
                                                            <p class="form-control" >HR</p>
                                                        @elseif(Auth::user()->role == 'content_manager')
                                                            <p class="form-control" >Content Manager</p>
                                                        @elseif(Auth::user()->role == 'viewer')
                                                            <p class="form-control" >Viewer</p>
                                                        @else
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        @if(Auth::user()->department)
                                                            <p class="form-control">{{ Auth::user()->department->name }}</p>
                                                        @else
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        @if(Auth::user()->designation)
                                                            <p class="form-control">{{ Auth::user()->designation->name }}</p>
                                                        @else

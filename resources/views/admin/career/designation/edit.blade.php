                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row" method="POST" action="{{route('career-designation.update', Crypt::encryptString($career_designation->id))}}">
                                @csrf
                                @method('patch')
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <select class="form-control select2 form-select" name="career_department_id" data-placeholder="Choose one department" required>
                                        @foreach($career_departments as $department)
                                            <option value="{{ $department->id }}" {{ optional($career_designation)->career_department_id == $department->id ? 'selected' : '' }}>
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Enter designation name" value="{{ $career_designation->name }}" required />

                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Manage Demo Request Messages</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        ...
                                        <span class="d-inline-block ms-2" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="View">
                                            <a href="{{route('demo-request.show', Crypt::encryptString($demo_request->id))}}" class="text-primary mx-1"><i class="fa fa-eye"></i></a>
                                        </span>
                                        {{--                                        @endif--}}
                                        ...
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="Delete">
                                                <form action="{{ route('demo-request.destroy', $demo_request->id )}}" method="post" id="deleteForm{{ $demo_request->id }}">
                                                    @csrf

                                                    <button class="text-danger border-0" type="submit" onclick="return deleteAction('{{ $demo_request->id }}', 'Are you sure to delete this contact message?', 'btn-danger')">
